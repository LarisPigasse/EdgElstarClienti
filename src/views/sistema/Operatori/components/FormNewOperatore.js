...
import { insertOperatori,getOperatori } from '../store/dataSlice'
...
const FormNewOperatore = () => {
    ...
    const onSubmit = async (formValue, setSubmitting) => {
       ...
       let { profilo,stato } = formValue
        ...
        let ok = await insertOperatori(formValue);
        ...
        toast.push(
            <Notification
                title="Operatore registrato con successo."
                type="success"
                duration={3500}
            >
                qualcosa...
...
export default FormNewOperatore
