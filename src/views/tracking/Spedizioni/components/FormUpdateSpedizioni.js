...
import { updateSpedizioni,getSpedizioni } from '../store/dataSlice'
...
const FormUpdateSpedizioni = () => {
    ...
    const statiSpedizioni = useSelector(
        (state) => state.trackingSpedizioni.state.statiSpedizioni
    )

    const archiviateSpedizioni = useSelector(
        (state) => state.trackingSpedizioni.state.archiviateSpedizioni
    )
   ...
   const initialStateSpedizioni = {
        id_cliente: dataSpedizioni.id_cliente,
        id_spedizione: dataSpedizioni.id_spedizione,
        id_corriere: dataSpedizioni.id_corriere,
        data_spedizione: dataSpedizioni.data_spedizione,
        altro_numero: dataSpedizioni.altro_numero,                
        destinazione: dataSpedizioni.destinazione,
        destinatario: dataSpedizioni.destinatario,
        indirizzo: dataSpedizioni.indirizzo,
        cap: dataSpedizioni.cap,
        citta: dataSpedizioni.citta,
        codice_nazione: dataSpedizioni.codice_nazione,
        discriminante: dataSpedizioni.discriminante,
        tracking: dataSpedizioni.tracking,
        data_tracking: dataSpedizioni.data_tracking,                                 
        archiviata: dataSpedizioni.archiviata,                
        stato: dataSpedizioni.stato
    }
    ...
    const onSubmit = async (formValue, setSubmitting) => {
        ...
        await updateSpedizioni(formValue, formValue.id_operatore);
        ...
        toast.push(
            <Notification
                title="Spedizione modificata con successo."
                type="success"
                duration={3500}
            >
                qualcosa...
    ...
    return (
        <Formik
            initialValues={initialStateSpedizioni}
...
export default FormUpdateSpedizioni
